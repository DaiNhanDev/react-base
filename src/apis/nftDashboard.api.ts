    ...
    res([
      {
        image:
          ...
          '/recently-added/ezgif.com-gif-maker_1_na4ogi.gif',
        title: 'XCopy Humano',
        author: 'neithanwolf',
        currentBid: 3521,
      ...
      },
      {
        image:
          process.env.REACT_APP_ASSETS_BUCKET +
          '/recently-added/borth-of-universe.webp',
      ...
      },
      {
        image:
          process.env.REACT_APP_ASSETS_BUCKET +
          '/recently-added/night-deprivation.webp',
      ...
      },
      {
        image:
          process.env.REACT_APP_ASSETS_BUCKET +
          '/recently-added/ezgif.com-gif-maker_t2caul.gif',
        title: 'Spiral Hole',
        author: 'jo_wo_le',
        currentBid: 311,
