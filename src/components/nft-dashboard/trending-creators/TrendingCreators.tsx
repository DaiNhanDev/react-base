...
import { TrendingCreatorsStory } from 'components/nft-dashboard/trending-creators/story/TrendingCreatorsStory';
import { useResponsive } from 'hooks/useResponsive';
import { getTrendingCreators, TrendingCreator } from 'apis/trendingCreators';
          ...
          <Stories
            ...
            onStoryStart={(storyNumber: number) => {
              setStories((prevStories) => {
                ...
                storiesCopy.splice(storyNumber, 1, {
                  ...prevStories[storyNumber],
                  viewed: true,
                });
