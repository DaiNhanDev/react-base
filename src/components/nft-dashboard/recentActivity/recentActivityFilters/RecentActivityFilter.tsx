...
import { RecentActivityStatusFilter } from 'components/nft-dashboard/recentActivity/recentActivityFilters/RecentActivityStatusFilter/RecentActivityStatusFilter';
...
export const RecentActivityFilter: React.FC<RecentActivityFilterProps> = ({
  filters,
  setFilters,
  withWrapper,
}) => {
  const filter = (
    <RecentActivityStatusFilter filters={filters} setFilters={setFilters} />
  );
