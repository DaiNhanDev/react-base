...
import { RecentActivityHeader } from 'components/nft-dashboard/recentActivity/RecentActivityHeader/RecentActivityHeader';
import { RecentActivityFeed } from 'components/nft-dashboard/recentActivity/recentActivityFeed/RecentActivityFeed';
...
import { Activity, getActivities } from 'apis/activity.api';
...
export const RecentActivity: React.FC = () => {
  ...
  const next = () => {
    getActivities().then((newActivity) =>
