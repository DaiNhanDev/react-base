...
import { TrendingCollection } from 'components/nft-dashboard/trending-collections/collection/TrendingCollection';
import { useResponsive } from 'hooks/useResponsive';
import { getTrendingActivities, TrendingActivity } from 'apis/activity.api';
...
export const TrendingCollections: React.FC = () => {
  ...
  const trendingList = useMemo(() => {
    return {
      mobile: trending
        .map((item, index) => <TrendingCollection key={index} {...item} />)
        .slice(0, 3),
