...
import { BaseSlider } from 'components/common/BaseSlider/BaseSlider';
import { BaseUpload } from 'components/common/BaseUpload/BaseUpload';
import { BaseRate } from 'components/common/BaseRate/BaseRate';
...
export const ValidationForm: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <BaseRadio.Group>
          <BaseRadio.Button value="a">
            {t('forms.validationFormLabels.item')} 1
          </BaseRadio.Button>
          <BaseRadio.Button value="b">
            {t('forms.validationFormLabels.item')} 2
          </BaseRadio.Button>
          <BaseRadio.Button value="c">
            {t('forms.validationFormLabels.item')} 3
          </BaseRadio.Button>
        </BaseRadio.Group>
      </BaseButtonsForm.Item>
