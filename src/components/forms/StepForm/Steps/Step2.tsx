...
import { BaseDatePicker } from 'components/common/pickers/BaseDatePicker';
import {
  BaseSelect,
  Option,
...
export const Step2: React.FC = () => {
  ...
  return (
    <S.FormContent>
      ...
      >
        <BaseRadio.Group>
          <BaseRadio.Button value="mr">
            {t('forms.stepFormLabels.mr')}
          </BaseRadio.Button>
          <BaseRadio.Button value="mrs">
            {t('forms.stepFormLabels.mrs')}
          </BaseRadio.Button>
        </BaseRadio.Group>
      </BaseForm.Item>
      <BaseForm.Item
